...
import vertexShader_atmos from './atmosphere_vert.glsl?raw';
import fragmentShader_atmos from './atmosphere_frag.glsl?raw';

import vertexShader_atmos_glow from './atmosphere_glow_vert.glsl?raw'
import fragmentShader_atmos_glow from './atmosphere_glow_frag.glsl?raw'

import vertexShader_clouds_vert from './clouds/clouds_vert.glsl?raw'
import vertexShader_clouds_frag from './clouds/clouds_frag.glsl?raw'
...
// #region
    ...
    // #region
    // Loading texture
    const texture_map_mars = texture_loader.load('./sphere_texture_mars_8k.jpg');

    // Loading normal map
    const normal_map_mars = texture_loader.load('./normal_map_mars.png')

    // Loading displacement map
    const displacement_map_mars = texture_loader.load('./displacement_map_mars.png')
    ...
    const material_mars_atmos = new THREE.ShaderMaterial({
        ...
        vertexShader:vertexShader_atmos,
        fragmentShader:fragmentShader_atmos,
    ...
    const material_mars_atmos_glow = new THREE.ShaderMaterial({
        ...
        vertexShader:vertexShader_atmos_glow,
        fragmentShader:fragmentShader_atmos_glow,
        // Allows transparency
        transparent:true,
        blending: THREE.AdditiveBlending,
        depthWrite:false,
    ...
    phobos_loader.load('/assets/models/phobos_original.glb',(gltf)=>{
        phobos = gltf.scene;
